    ...
    return (
        <section id="projects" className="sections">
            ...
            <div id="projects-list">
                ...
                <ProjectCard url="https://github.com/IngenHouzs/Projek-UTS-Web-Programming" title="Prolangram" description="Simple Stack Overflow clone built with PHP Native, created to allow developers build communities and help each other." image={Prolangram}/>           
